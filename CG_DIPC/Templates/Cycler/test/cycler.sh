...
gmx grompp -f ${PREFIX}.mdp -o ${PREFIX}_${ITERATION}.tpr -c ${PREFIX}.gro -t $checkpoint -p system.top -n index.ndx

gmx mdrun -deffnm ${PREFIX}_${ITERATION} -cpt 0.5  -maxh 0.034
